    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Captain Login</p>
        </div>

        {/* Login Card */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-xl">
          <h2 className="text-2xl font-bold text-white mb-2">Login as Captain</h2>
          <p className="text-gray-400 text-sm mb-6">Start earning by driving with Uber</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-lg transition disabled:opacity-50">
          ...
          <p className="text-center mt-6 text-gray-300">
            ...
            <Link to="/captain-signup" className="text-green-400 hover:text-green-300 font-semibold">
              Sign up
            </Link>
          </p>
